...
public class TajoConf extends Configuration {
  ...
  public static enum ConfVars {
    ...
    // Physical Executors
    //////////////////////////////////
    EXECUTOR_EXTERNAL_SORT_BUFFER_SIZE("tajo.executor.external-sort.buffer-bytes", 400 * 1048576),
    EXECUTOR_EXTERNAL_SORT_FANOUT("tajo.executor.external-sort.fanout-num", 1),
