...
public class TestTajoJdbc extends QueryTestCaseBase {
  ...
  public static void setUp() throws Exception {
    ...
    tajoMasterAddress = NetUtils.createSocketAddr(tajoConf.getVar(TajoConf.ConfVars.TAJO_MASTER_CLIENT_RPC_ADDRESS));
  ...
  public void testDatabaseMetaDataGetTable() throws Exception {
    ...
    try {
      ...
      List<String> tableNames = new ArrayList<String>(
          tpch.getTestingCluster().getMaster().getCatalog().getAllTableNames(DEFAULT_DATABASE_NAME));
  ...
  public void testDatabaseMetaDataGetColumns() throws Exception {
    ...
    try {
      ...
      TableDesc tableDesc = tpch.getTestingCluster().getMaster().getCatalog()
          .getTableDesc(DEFAULT_DATABASE_NAME, tableName);
