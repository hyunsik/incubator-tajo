  ...
  public class TajoMasterClientProtocolServiceHandler implements TajoMasterClientProtocolService.BlockingInterface {
    ...
    public GetClusterInfoResponse getClusterInfo(RpcController controller,
      ...
      for(Worker worker: workers.values()) {
        ...
        workerBuilder.setLastHeartbeat(workerResource.getLastHeartbeat());
        ...
        workerBuilder.setWorkerStatus(workerResource.getWorkerStatus().toString());
        ...
        workerBuilder.setHttpPort(workerResource.getHttpPort());
