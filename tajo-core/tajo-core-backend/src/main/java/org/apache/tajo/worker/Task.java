...
public class Task {
  ...
  private TaskCompletionReport getTaskCompletionReport() {
    ...
    System.out.println("getTaskCompletionReport.Input>>>>>" + builder.getInputStats());
  ...
  private synchronized void fetcherFinished(TaskAttemptContext ctx, Fetcher fetcher) {
