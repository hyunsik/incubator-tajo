...
public class PartitionDesc implements ProtoObject<CatalogProtos.PartitionDescProto>, Cloneable, GsonObject {
  ...
  @Expose protected String cacheNodes;                         // optional
  ...
  public PartitionDesc(PartitionDesc partition) {
    ...
    this.cacheNodes = partition.cacheNodes;
  }

  public PartitionDesc(CatalogProtos.PartitionType partitionType, Column[] columns) {
...
//      addColumn(c);
  ...
  public PartitionDesc(CatalogProtos.PartitionDescProto proto) {
    ...
    if(proto.hasCacheNodes()) {
      this.cacheNodes = proto.getCacheNodes();
    }
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof PartitionDesc) {
      ...
      eq = eq && ((cacheNodes != null && another.cacheNodes != null
          && cacheNodes.equals(another.cacheNodes)) ||
          (cacheNodes == null && another.cacheNodes == null));
      return eq;
    }
    return false;
  }
  ...
  public CatalogProtos.PartitionDescProto getProto() {
    ...
    if(this.cacheNodes != null) {
      builder.setCacheNodes(this.cacheNodes);
    }
